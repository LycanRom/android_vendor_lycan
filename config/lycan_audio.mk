...
ALARM_PATH := vendor/lycan/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/lycan/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/lycan/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/lycan/prebuilt/common/media/audio/ui
